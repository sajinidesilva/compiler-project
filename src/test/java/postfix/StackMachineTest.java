...
public class StackMachineTest {
    ...
    @Test
    public void testEvaluateTwoMultiplicationOp() throws Exception {
        StackMachine stackMachine =new StackMachine();
        Num numToken1=new Num(1);
        Num numToken2=new Num(2);
    ...
    @Test
    public void testEvaluateThreeAdditionOp() throws Exception {
        StackMachine stackMachine =new StackMachine();
        Id idToken1=new Id(257,"a");
        idToken1.value=1;
        Id idToken2=new Id(257,"b");
    ...
    @Test
    public void testEvaluateFourMultiplicationOp() throws Exception {
        StackMachine stackMachine =new StackMachine();
        Real realToken1=new Real(1.0f);
        Real realToken2=new Real(2.0f);
        ...
        Assert.assertEquals("Final Result is Real tag",259,tok.tag);
        Assert.assertEquals("Final Result of postfix + of 1.0f & 2.0f",2.0f,stackMachine.value);
    ...
    @Test
    public void testEvaluateFiveMultiplicationOp() throws Exception {
        StackMachine stackMachine =new StackMachine();
        Num numToken1=new Num(2);
        Real realToken2=new Real(3.0f);
        ...
        Assert.assertEquals("Final Result is Real tag",259,tok.tag);
        Assert.assertEquals("Final Result of postfix + of 1.0f & 2.0f",6.0f,stackMachine.value);



    }
    @Test
    public void testEvaluateNine() throws Exception {
        StackMachine stackMachine =new StackMachine();
        Real realToken1=new Real(2.0f);
        Num numToken2=new Num(2);
    ...
    @Test
    public void testEvaluateNineMultiplicationOp() throws Exception {
        StackMachine stackMachine =new StackMachine();
        Real realToken1=new Real(2.0f);
        Num numToken2=new Num(3);
